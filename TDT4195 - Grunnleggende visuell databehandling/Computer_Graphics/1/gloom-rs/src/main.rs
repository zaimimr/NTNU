...
unsafe fn vao(vertex_cords: &Vec<f32>, indices: &Vec<u32>) -> u32 {
...
fn main() {
    ...
    let render_thread = thread::spawn(move || {
        ...
        unsafe {
            ...
            let mut indecies: Vec<u32> = vec![];
            let segments = 3000;
            let mut r = 0.4;
            let mut index = 0;
            for i in 0..segments {
                
                let section: f32 = i as f32 / segments as f32;
                let theta: f32 = 2.0 * 3.1415926 * section;
                ...
                indecies.push(index);
                indecies.push(index+1);
                indecies.push(index+2);
                index += 3;

            }


            vao(&vertices, &indecies);
        }
        ...
        loop {
            ...
            unsafe {
                ...
                gl::DrawElements(gl::LINE_STRIP, 1000 * 3, gl::UNSIGNED_INT, ptr::null());
            }
